...
class BoxOfficeViewController: BaseGridViewController, UISearchBarDelegate {
    ...
    override func feedURL() -> String {
        return "http://api.rottentomatoes.com/api/public/v1.0/lists/movies/box_office.json?apikey=dagqdghwaq3e3mxyrp7kmmj5&limit=20&country=US"
    }
}